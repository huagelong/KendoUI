...
class DropDownListRemote extends Base
{
    ...
    public function perform($param)
    {
        ...
        return $str.'<?php echo \Trensy\KendoUI\BladexEx\DropDownListRemote::deal('.$param.'); ?>';
    }
     ...
     */
    public static function deal($url, $name='dl',$value='',$options=[],$type="POST", $parameterMap=null)
    {
